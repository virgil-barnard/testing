(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))b(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const u of o.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&b(u)}).observe(document,{childList:!0,subtree:!0});function M(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function b(s){if(s.ep)return;s.ep=!0;const o=M(s);fetch(s.href,o)}})();const Xe=`@group(0) @binding(0) var samplerLinear : sampler;\r
...
`,L=document.getElementById("canvas"),x=document.getElementById("video"),ar=document.getElementById("grad-l1"),ur=document.getElementById("video-fps"),sr=document.getElementById("inference-fps");(async()=>{const O=await navigator.gpu.requestAdapter();if(!O){alert("WebGPU not supported");return}const e=await O.requestDevice(),M=L.getContext("webgpu"),b=navigator.gpu.getPreferredCanvasFormat();M.configure({device:e,format:b});const s=await navigator.mediaDevices.getUserMedia({video:!0});x.srcObject=s,await new Promise(n=>x.onloadedmetadata=n),L.width=x.videoWidth,L.height=x.videoHeight;const o=[L.width,L.height],u=GPUTextureUsage.TEXTURE_BINDING,l=GPUTextureUsage.STORAGE_BINDING,y=GPUTextureUsage.RENDER_ATTACHMENT,p=GPUTextureUsage.COPY_DST,ve=GPUTextureUsage.COPY_SRC,d=(n,t="rgba8unorm",a=o)=>e.createTexture({size:a,format:t,usage:n}),m=e.createSampler({magFilter:"linear",minFilter:"linear"}),C=3,g=Array.from({length:C},(n,t)=>[Math.max(1,o[0]>>t),Math.max(1,o[1]>>t)]);let P=g.map((n,t)=>t===0?d(u|y|p|l,"rgba8unorm",n):d(u|y|p,"bgra8unorm",n)),f=g.map((n,t)=>t===0?d(u|y|p|l,"rgba8unorm",n):d(u|y|p,"bgra8unorm",n)),h=g.map(n=>d(u|l|p,"rgba16float",n));const w=d(u|p|y);d(u|l);const z=d(u|l),I=d(u|l),N=d(u|l|y),K=d(u|l),Y=d(u|l),V=d(u|l|ve,"rgba8unorm",o),H=d(u|l,"rgba8unorm"),j=d(u|p,"rgba8unorm",o);let W=new Float32Array(9).fill(.1);const B=e.createTexture({size:[3,3],format:"r32float",usage:u|p});e.queue.writeTexture({texture:B},W,{bytesPerRow:3*4},[3,3]);const X=e.createShaderModule({code:Xe}),xe=e.createShaderModule({code:Je}),be=e.createShaderModule({code:Qe}),ye=e.createShaderModule({code:Ze}),we=e.createShaderModule({code:$e}),_e=e.createShaderModule({code:er}),Pe=e.createShaderModule({code:rr}),J=e.createShaderModule({code:nr}),he=e.createShaderModule({code:tr}),Be=e.createShaderModule({code:ir}),Se=e.createShaderModule({code:or}),Q=e.createRenderPipeline({layout:"auto",vertex:{module:X,entryPoint:"vs_main"},fragment:{module:X,entryPoint:"fs_main",targets:[{format:b}]},primitive:{topology:"triangle-strip"}}),Z=e.createComputePipeline({layout:"auto",compute:{module:Pe,entryPoint:"main"}}),$=e.createComputePipeline({layout:"auto",compute:{module:_e,entryPoint:"main"}}),_=e.createComputePipeline({layout:"auto",compute:{module:xe,entryPoint:"main"}}),A=e.createComputePipeline({layout:"auto",compute:{module:be,entryPoint:"main"}}),ee=e.createComputePipeline({layout:"auto",compute:{module:ye,entryPoint:"main"}}),re=e.createComputePipeline({layout:"auto",compute:{module:we,entryPoint:"main"}}),ne=e.createComputePipeline({layout:"auto",compute:{module:he,entryPoint:"main"}}),te=e.createComputePipeline({layout:"auto",compute:{module:Be,entryPoint:"main"}}),ie=e.createRenderPipeline({layout:"auto",vertex:{module:J,entryPoint:"vs_main"},fragment:{module:J,entryPoint:"fs_main",targets:[{format:b}]},primitive:{topology:"triangle-strip"}}),oe=e.createComputePipeline({layout:"auto",compute:{module:Se,entryPoint:"main"}}),S=e.createBuffer({size:9*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),U=e.createBuffer({size:9*4,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),D=(n=32)=>e.createBuffer({size:n,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),ae=D(),ue=D(),se=D(16),G=e.createBuffer({size:8,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,mappedAtCreation:!0});new Float32Array(G.getMappedRange()).set(o),G.unmap();const ce=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});function Ge(n,t){return e.createBindGroup({layout:Z.getBindGroupLayout(0),entries:[{binding:0,resource:n.createView()},{binding:1,resource:m},{binding:2,resource:t.createView()}]})}function Te(n,t,a){return e.createBindGroup({layout:$.getBindGroupLayout(0),entries:[{binding:0,resource:n.createView()},{binding:1,resource:t.createView()},{binding:2,resource:a.createView()}]})}function Le(n,t,a){return e.createBindGroup({layout:ne.getBindGroupLayout(0),entries:[{binding:0,resource:n.createView()},{binding:1,resource:t.createView()},{binding:2,resource:a.createView()},{binding:3,resource:m}]})}function Me(n,t){return e.createBindGroup({layout:te.getBindGroupLayout(0),entries:[{binding:0,resource:n.createView()},{binding:1,resource:t.createView()},{binding:2,resource:{buffer:S}}]})}function Ce(){return e.createBindGroup({layout:ie.getBindGroupLayout(0),entries:[{binding:0,resource:m},{binding:1,resource:w.createView()},{binding:2,resource:V.createView()}]})}const Ve=e.createBindGroup({layout:A.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ae}},{binding:1,resource:m},{binding:2,resource:w.createView()},{binding:3,resource:z.createView()}]}),Ae=e.createBindGroup({layout:A.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ue}},{binding:1,resource:m},{binding:2,resource:w.createView()},{binding:3,resource:I.createView()}]}),Ue=e.createBindGroup({layout:_.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:G}},{binding:1,resource:z.createView()},{binding:2,resource:B.createView()},{binding:3,resource:N.createView()}]}),ke=e.createBindGroup({layout:_.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:G}},{binding:1,resource:I.createView()},{binding:2,resource:B.createView()},{binding:3,resource:K.createView()}]}),Ee=e.createBindGroup({layout:ee.getBindGroupLayout(0),entries:[{binding:0,resource:K.createView()},{binding:1,resource:Y.createView()},{binding:2,resource:{buffer:se}},{binding:3,resource:m}]}),Oe=e.createBindGroup({layout:re.getBindGroupLayout(0),entries:[{binding:0,resource:N.createView()},{binding:1,resource:Y.createView()},{binding:2,resource:z.createView()},{binding:3,resource:{buffer:S}}]}),ze=e.createBindGroup({layout:_.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:G}},{binding:1,resource:w.createView()},{binding:2,resource:B.createView()},{binding:3,resource:V.createView()}]}),We=e.createBindGroup({layout:oe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ce}},{binding:1,resource:m},{binding:2,resource:w.createView()},{binding:3,resource:f[0].createView()}]});function de(){const n=.6+Math.random()*.3,t=Math.random()*(1-n),a=Math.random()*(1-n),r=()=>.1+Math.random()*.8;return new Float32Array([t,a,n,n,r(),r(),r(),0])}function De(){return new Float32Array([(Math.random()-.5)*.2,(Math.random()-.5)*.2,1,1])}function v(n,t,a){n.setPipeline(t),n.setBindGroup(0,a),n.dispatchWorkgroups(Math.ceil(o[0]/8),Math.ceil(o[1]/8))}function le(n,t){const a=e.createCommandEncoder(),r=a.beginRenderPass({colorAttachments:[{view:t.createView(),loadOp:"clear",storeOp:"store",clearValue:[0,0,0,1]}]}),i=e.createBindGroup({layout:Q.getBindGroupLayout(0),entries:[{binding:0,resource:m},{binding:1,resource:n.createView()}]});r.setPipeline(Q),r.setBindGroup(0,i),r.draw(4),r.end(),e.queue.submit([a.finish()])}const k=32,E=24,ge=new OffscreenCanvas(k,E).getContext("2d"),F=new Float32Array(8);function Fe(){ge.drawImage(x,0,0,k,E);const n=ge.getImageData(0,0,k,E).data,t=[0,0,0],a=[0,0,0],r=k*E;for(let i=0;i<n.length;i+=4)for(let c=0;c<3;c++){const T=n[i+c]/255;t[c]+=T,a[c]+=T*T}for(let i=0;i<3;i++){const c=t[i]/r,T=a[i]/r-c*c,je=1/Math.sqrt(T+1e-6);F[i]=c,F[4+i]=je}e.queue.writeBuffer(ce,0,F)}const Re=10,qe=.01,Ie=1e6;async function Ne(){const n=e.createCommandEncoder();n.copyBufferToBuffer(S,0,U,0,S.size),e.queue.submit([n.finish()]),await U.mapAsync(GPUMapMode.READ);const t=new Int32Array(U.getMappedRange());let a=0;for(let r=0;r<9;r++){const i=t[r]/Ie;a+=Math.abs(i),W[r]-=qe*i}U.unmap(),e.queue.writeTexture({texture:B},W,{bytesPerRow:3*4},[3,3]),e.queue.writeBuffer(S,0,new Float32Array(9)),ar.textContent=a.toExponential(3)}let Ke=0,R=0,q=0,pe=performance.now(),me=performance.now();function Ye(){++R&&performance.now()-pe>=1e3&&(ur.textContent=String(R),R=0,pe=performance.now())}function He(){++q&&performance.now()-me>=1e3&&(sr.textContent=String(q),q=0,me=performance.now())}function fe(){e.queue.copyExternalImageToTexture({source:x},{texture:w},o),Ye(),Fe();{const r=e.createCommandEncoder(),i=r.beginComputePass();i.setPipeline(oe),i.setBindGroup(0,We),i.dispatchWorkgroups(Math.ceil(o[0]/8),Math.ceil(o[1]/8)),i.end(),e.queue.submit([r.finish()])}e.queue.copyExternalImageToTexture({source:x},{texture:f[0]},o);for(let r=1;r<C;r++)le(f[r-1],f[r]),le(P[r-1],P[r]);for(let r=C-1;r>=0;r--){const i=e.createCommandEncoder(),c=i.beginComputePass();r<C-1?(c.setPipeline(Z),c.setBindGroup(0,Ge(h[r+1],h[r])),c.dispatchWorkgroups(Math.ceil(g[r][0]/8),Math.ceil(g[r][1]/8))):e.queue.writeTexture({texture:h[r]},new Float32Array(g[r][0]*g[r][1]*4).fill(0),{bytesPerRow:g[r][0]*16},g[r]),c.setPipeline($),c.setBindGroup(0,Te(P[r],f[r],h[r])),c.dispatchWorkgroups(Math.ceil(g[r][0]/8),Math.ceil(g[r][1]/8)),c.end(),e.queue.submit([i.finish()])}{const r=e.createCommandEncoder(),i=r.beginComputePass();i.setPipeline(ne),i.setBindGroup(0,Le(j,h[0],H)),i.dispatchWorkgroups(Math.ceil(o[0]/8),Math.ceil(o[1]/8)),i.end(),e.queue.submit([r.finish()])}{const r=e.createCommandEncoder(),i=r.beginComputePass();i.setPipeline(te),i.setBindGroup(0,Me(V,H)),i.dispatchWorkgroups(Math.ceil(o[0]/8),Math.ceil(o[1]/8)),i.end(),e.queue.submit([r.finish()])}e.queue.writeBuffer(ae,0,de()),e.queue.writeBuffer(ue,0,de()),e.queue.writeBuffer(se,0,De());const n=e.createCommandEncoder(),t=n.beginComputePass();v(t,A,Ve),v(t,A,Ae),v(t,_,Ue),v(t,_,ke),v(t,ee,Ee),v(t,re,Oe),v(t,_,ze),t.end();const a=n.beginRenderPass({colorAttachments:[{view:M.getCurrentTexture().createView(),loadOp:"clear",storeOp:"store",clearValue:[0,0,0,1]}]});a.setPipeline(ie),a.setBindGroup(0,Ce()),a.draw(4),a.end(),e.queue.submit([n.finish()]),He();{const r=e.createCommandEncoder();r.copyTextureToTexture({texture:V},{texture:j},o),e.queue.submit([r.finish()])}++Ke%Re===0&&Ne().catch(console.error),[f,P]=[P,f],requestAnimationFrame(fe)}requestAnimationFrame(fe)})().catch(console.error);
